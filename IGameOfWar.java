...
public interface IGameOfWar {
  /**
   * Initializes the game with the given deck. 
   * Each player should be dealt half the cards in the deck.
   * 
  ...
  /**
   * Returns a Stack of cards that is the combination of top and bottom. 
   * The top stack should be on top of the bottom
   * stack.
   * 
